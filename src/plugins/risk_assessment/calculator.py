...
def calculate_risk_score(
    ...
    if score < 25:
        ...
        # TODO: look into whether this should suggest a specific rebalancing strategy
        recommendation = "Significant risk detected. Review and reduce high-risk positions."
    else:
